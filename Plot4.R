...
par(mfcol = c(2,2), oma = c(1,1,1, 1), mar = c(4, 4, 1, 1))
# 1
plot(hpc_data$date_time, hpc_data$Global_active_power, type = "n", ylab = "Global Active Power", xlab = "")
lines(hpc_data$date_time, hpc_data$Global_active_power, lty=1)
#2
...
# 3
plot(hpc_data$date_time, hpc_data$Voltage, type = "n", 
     ylab = "Voltage", xlab = "datetime")
lines(hpc_data$date_time, hpc_data$Voltage, lty = 1)
#4
plot(hpc_data$date_time, hpc_data$Global_reactive_power, type = "n", xlab = "datetime", ylab = "Global reactive power")
lines(hpc_data$date_time, hpc_data$Global_reactive_power, lty = 1)
dev.off()